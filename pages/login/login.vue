<template>
	<view class="bg-red" style="height: 100vh;">
        <view class="logo">
			<view class="img">
		...
		<!-- 账号密码输入框 -->
		<view class=" flex padding-tb-lg text-xxl align-center padding-lr-xl justify-between">
			<button class="bg-white text-black cu-btn round padding-lr-xl" style="width: 48%;">取消</button>
			<button class="bg-green text-white cu-btn round padding-lr-xl" style="width: 48%;">登录</button>
		</view>
	</view>
</template>
